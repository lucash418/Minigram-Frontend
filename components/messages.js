...
export const Messages = () => {
  return (
   ...
   <div className='message-name-1'>Harry Kenvic</div>
   <div className='message-icon-2'>
   ...
   <div className='message-name-2'>Harry Kenvic</div>
   <div className='message-icon-3'>
   <Avatar alt="Remy Sharp" src="https://m.media-amazon.com/images/M/MV5BMTA2OTU0MjEwMDVeQTJeQWpwZ15BbWU4MDIzNjU1MTAx._V1_.jpg" ></Avatar> </div> 
   <div className='message-name-3'>Harry Kenvic</div>
   <div className='message-icon-4'>
   <Avatar alt="Remy Sharp" src="https://m.media-amazon.com/images/M/MV5BMTA2OTU0MjEwMDVeQTJeQWpwZ15BbWU4MDIzNjU1MTAx._V1_.jpg" ></Avatar> </div> 
   <div className='message-name-4'>Harry Kenvic</div>
